...
public class LoginPanel extends JPanel
{
	...
	public LoginPanel()
	{
		...
		logoname = new JLabel(new ImageIcon("users_title.png"));
		logo = new JLabel(new ImageIcon("meal1.jpg"));
	...
	private class enter_click implements MouseListener
	{
		...
		public void mousePressed(MouseEvent arg0) 
		{
			try
			{
				...
				if(User.checkExistence(Integer.valueOf(userenter.getText()), pswenter.getText()))
					Frame.openTransactionsPanel();
				else
				{
